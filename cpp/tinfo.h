...
namespace __cxxabiv1 {
  ...
  inline bool __pbase_type_info::__pointer_catch( const __pbase_type_info *thrown_type, void **thr_obj, unsigned outer ) const {
  ...
  namespace {
    ...
    template< typename T >
    inline const T *
    adjust_pointer( const void *base, std::ptrdiff_t offset ) {
    ...
    inline void const *
    convert_to_base( void const *addr, bool is_virtual, std::ptrdiff_t offset ) {
      if ( is_virtual ) {
        const void *vtable = *static_cast< const void * const * > ( addr );

        offset = *adjust_pointer< std::ptrdiff_t > ( vtable, offset );
      }
    ...
    static_cast <const __class_type_info *> (0) + 1;
        ...
        __find_public_src (std::ptrdiff_t src2dst,
            const void *obj_ptr,
