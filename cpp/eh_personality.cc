...
parse_lsda_header( _Unwind_Context *context, const unsigned char *p, lsda_header_info *info ) {
  _uleb128_t tmp;
...
static bool get_adjusted_ptr( const std::type_info *catch_type, const std::type_info *throw_type, void **thrown_ptr_p ) {
...
static bool check_exception_spec( lsda_header_info* info, _throw_typet* throw_type, void* thrown_ptr, _sleb128_t filter_value ) {
...
static inline void save_caught_exception( struct _Unwind_Exception* ue_header, struct _Unwind_Context* context
			__attribute__((__unused__)), void* thrown_ptr, int handler_switch_value,
    const unsigned char* language_specific_data, _Unwind_Ptr landing_pad __attribute__((__unused__)), const unsigned char* action_record ) {
...
static inline void restore_caught_exception( struct _Unwind_Exception* ue_header, int& handler_switch_value, const unsigned char*& language_specific_data, _Unwind_Ptr& landing_pad ) {
  __cxa_exception* xh = __get_exception_header_from_ue(ue_header);
...
#define PERSONALITY_FUNCTION	__gxx_personality_v0
  ...
  PERSONALITY_FUNCTION (_Unwind_State state,
      ...
      struct _Unwind_Context* context)
#else
  PERSONALITY_FUNCTION( int version, _Unwind_Action actions, _Unwind_Exception_Class exception_class, struct _Unwind_Exception *ue_header, struct _Unwind_Context *context )
#endif
  {
