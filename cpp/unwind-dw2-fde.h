...
extern void __register_frame_info_bases( const void *, struct object *, void *, void * );
extern void __register_frame_info( const void *, struct object * );
extern void __register_frame( void * );
extern void __register_frame_info_table_bases( void *, struct object *, void *, void * );
...
get_cie( const struct dwarf_fde *f ) {
  return ( const dwarf_cie* ) ( ( const void * ) &f->CIE_delta - f->CIE_delta );
}
...
static inline int last_fde( struct object *obj __attribute__ ((__unused__)), const fde *f ) {
#ifdef DWARF2_OBJECT_END_PTR_EXTENSION
